...
Blame for this code base goes to Dave Hoover (@redsquirrel), who started it all by twittering about working on a Sudoku solver ("http://github.com/redsquirrel/nest/tree/master/sudoku":http://github.com/redsquirrel/nest/tree/master/sudoku).
...
It seems that Corey Haines (@coreyhaines) has also caught the Sudoku solver bug and has posted his solution ("http://github.com/coreyhaines/sudoku_solver":http://github.com/coreyhaines/sudoku_solver).
